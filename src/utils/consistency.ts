...
function defaultListSelector(data: unknown): { items: EntityWithId[]; total?: number } | null {
  if (!data) return null;
...
function defaultWriteBack(old: unknown, items: EntityWithId[], total?: number): unknown {
