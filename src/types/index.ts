...
export interface MutationOptions<TData, TError, TVariables, TContext = unknown> extends UseMutationOptions<TData, TError, TVariables, TContext> {
  ...
  consistency?: { baseKey: QueryKey; mode?: "invalidate" | "sync+invalidate"; idField?: string; listSelector?: (data: unknown) => unknown[] | { items: unknown[]; total?: number } | null; maxKeys?: number };
}
